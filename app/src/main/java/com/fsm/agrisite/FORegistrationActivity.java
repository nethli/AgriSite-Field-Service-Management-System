...
public class FORegistrationActivity extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    private void CheckEmptyValues(String firstName, String lastName, String birthday, String email, String password, String confirm){
        if(firstName.isEmpty()){
            Toast.makeText(FORegistrationActivity.this, "Please Enter the First Name.", Toast.LENGTH_SHORT).show();

        } else if (lastName.isEmpty()) {
            Toast.makeText(FORegistrationActivity.this, "Please Enter the Last Name", Toast.LENGTH_SHORT).show();

        }else if (birthday.isEmpty()) {
            Toast.makeText(FORegistrationActivity.this, "This field can't be empty.", Toast.LENGTH_SHORT).show();
